  ...
  var cartRowContents = `
        ...
        <div class="cart-quantity cart-column">
          <input
            ...
            value="1"
          /><button
            class="btn btn-danger cart-quantity-button"
            type="button"
          >
            REMOVE
          </button>
...
cartRow.getElementsByClassName('like-button')[0].addEventListener('click', (event) => {
...
var likedButton = document.getElementsByClassName('like-button')
